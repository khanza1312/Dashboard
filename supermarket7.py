...
# ===================== TEAM INFORMATION =====================
TEAM_INFO = {
    "group_name": "Group 6 - Business Mathematics",
    "members": [
        "Khanza Dhobithoh Azzahra",
        "Carla Luisa Auxillia De Araujo Nunes Carlos", 
        "Esperansa Caroline Sidney",
        "Lingga El'Maura Majestya"
    ]
}
